<?php
	...
	head("<link href='assets/css/classes.css' type='text/css' rel='stylesheet' />" . 
					...
					<?php for ($j = 0; $j < count($types); $j++) { 
						...
						<div class="row">
							...
							for ($i = 0; $i < count($classes); $i++) { 
								?>
								<a href="course.php?id=<?= $classes[$i]['id'] ?>">
									<div class="class-wrap col-lg-4 col-sm-6 col-xs-12">
										<div class="class" style="background-image: url('assets/img/classes/<?= $classes[$i]['id'] ?>.jpg'), url('assets/img/classes/fallback.jpg'); background-size: cover;">
