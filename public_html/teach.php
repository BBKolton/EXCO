<?php
	require("common.php");
	head('<link href=".assets/css/teach.css" type="text/css" rel="stylesheet" />');
	?>
	...
	<section class="content">
		<div class="container">
			...
			<p>Please read our <a href="/asuwecwb/.assets/docs/instructorinfo.pdf"> prospective instructor information sheet</a>. If you want to work with the Experimental College, you can apply online <a href="TODO LAUNCH">here</a>. If you have any further questions, please <a href="/asuwecwb/about.php">contact us</a>.</p>
