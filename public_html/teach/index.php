<?php
	require("../common.php");
	head('<link href="/asuwecwb/.assets/css/teach.css" type="text/css" rel="stylesheet" />');
	?>
	...
	<section class="content">
		<div class="container">
			...
			<p>Please read our <a href="/asuwecwb/.assets/docs/instructorinfo.pdf"> prospective instructor information sheet</a>. If you want to work with the Experimental College, you can <b>apply online <a href="application.php">here</a>.</b> If you have any further questions, please <a href="/asuwecwb/about.php">contact us</a>.</p>
			<h2>Returning Instructors</h2>
			<p>If you're already an instructor with EXCO and want to propose a new class, please download the <a href="/asuwecwb/.assets/newcourseproposal.pdf">new course proposal form for existing instructors</a> and submit it to our office, or apply online <a href="application.php">here</a>.</p>
