`<?php
	...
	<section class="content">
		<div class="container">
			...
			<p>If you're already an instructor with EXCO and want to propose a new class, please download the <a href="/asuwxpcl/.assets/newcourseproposal.pdf">new course proposal form for existing instructors</a> and submit it to our office, or apply online <a href="application.php">here</a>.</p>
