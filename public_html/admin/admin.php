<?php
//Admin panel for changing account types, activating user accounts, etc.

require("../common.php");
session_start();

//User profile checks for admin
if (empty($_SESSION)) {
...
//Change account type if requested
...
//activate user account if requested
